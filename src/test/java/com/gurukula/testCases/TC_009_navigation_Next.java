...
public class TC_009_navigation_Next  extends BaseClass {



	@Test
	public void checknavigationNext() throws InterruptedException 	
	{
		...
		while (csf.linkNextNavigation.isDisplayed())
